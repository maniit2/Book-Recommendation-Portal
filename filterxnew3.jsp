...
$(".hello1").mouseenter(function(){
  ...
  <%! String soundex_method(String s,int k1) 
...
System.out.println("welcome --connection");
 ...
 String query2="select count(b_id) numb from books ";
System.out.println(query2);
ResultSet res2=smnt1.executeQuery(query2);
res2.next();
int p=res2.getInt("numb");
...
ResultSet res1=smnt2.executeQuery(query1);
int o=0;
 while(res1.next())
 {
 System.out.println("+++++++++++++++++++++++++++++++++++++++++++"); 
 ...
 try{
 String str1=soundex_method(abc,k1-k2);
 System.out.println(str1);
 String str2=soundex_method(name,k1-k2);
